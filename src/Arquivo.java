...
public class Arquivo {
    ...
    */
    ...
    //Feito por Lucas Lopes Fraga: (Iniciando arquivo sem a saida e setando a saida depois:
    ...
    public void createOutput(String classname, String packagename) throws IOException{
        File f = new File("src/" + packagename);
        f.mkdir();
        try {
        this.out = new PrintWriter(new FileWriter("src/" + packagename + "/" + classname + ".java"), true);
        } catch (IOException e) {
            throw new RuntimeException(e.toString());
        }
    }
